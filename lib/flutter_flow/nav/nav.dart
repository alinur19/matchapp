...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'trendPage',
          path: '/trendPage',
          builder: (context, params) => const TrendPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) => const CreateTournamentPageWidget(),
        ),
        FFRoute(
          name: 'fieldPage',
          path: '/fieldPage',
          builder: (context, params) => FieldPageWidget(
            fieldref: params.getParam(
              'fieldref',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['field'],
            ),
          ),
        ),
        FFRoute(
          name: 'postingPage',
          path: '/postingPage',
          builder: (context, params) => PostingPageWidget(
            userRef: params.getParam(
              'userRef',
              ParamType.DocumentReference,
              isList: false,
        ...
        FFRoute(
          name: 'createTeamPage',
          path: '/createTeamPage',
          builder: (context, params) => const CreateTeamPageWidget(),
        ),
        FFRoute(
          name: 'addFieldPage',
          path: '/addFieldPage',
          builder: (context, params) => const AddFieldPageWidget(),
        )
