...
import '/components/choose_team_widget.dart';
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: StreamBuilder<TournamentsRecord>(
            ...
            return Column(
              ...
              children: [
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: const EdgeInsetsDirectional.fromSTEB(
                                          4.0, 0.0, 0.0, 0.0),
                                      child: Text(
                                        '${columnTournamentsRecord.prize}тг.',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              fontFamily: 'Montserrat',
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        dateTimeFormat('d/M/y',
                                            columnTournamentsRecord.dataStart!),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              fontFamily: 'Montserrat',
                        ...
                        builder: (context) {
                          return GestureDetector(
                            ...
                            child: Padding(
                              ...
                              child: ChooseTeamWidget(
                                tournamentRef:
                                    columnTournamentsRecord.reference,
                              ),
                            ),
                          );
                        },
                ...
                Padding(
                  ...
                  child: Builder(
                    builder: (context) {
                      final item = columnTournamentsRecord.members.toList();
                        ...
                        itemBuilder: (context, itemIndex) {
                          ...
                          return Padding(
                            ...
                            child: StreamBuilder<TeamRecord>(
                              stream: TeamRecord.getDocument(itemItem),
                              builder: (context, snapshot) {
                                // Customize what your widget looks like when it's loading.
                                if (!snapshot.hasData) {
                                  return Center(
